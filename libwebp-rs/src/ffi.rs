...
pub unsafe extern "C" fn SharpYuvInit() {
    crate::sharpyuv::SharpYuvInit()
}

#[unsafe(no_mangle)]
pub unsafe extern "C" fn SharpYuvGetVersion() -> i32 {
    crate::sharpyuv::SharpYuvGetVersion()
}

#[unsafe(no_mangle)]
pub unsafe extern "C" fn SharpYuvGetConversionMatrix(
    matrix_type: crate::sharpyuv::SharpYuvMatrixType,
) -> *const crate::sharpyuv::SharpYuvConversionMatrix {
